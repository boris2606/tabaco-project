...
const Products = () => {
    ...
    const machinesArray = dataProductsArr.filter( product => product.category === 'machines')
    ...
    return (
        <section className={styles.wrapper_products}>
            <div className={styles.head_products_content}>
                <p className={styles.head_products_tit_txt}>
                    Великий вибір асортименту
                </p>
            </div>
